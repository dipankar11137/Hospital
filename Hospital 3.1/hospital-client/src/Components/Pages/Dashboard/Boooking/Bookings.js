  ...
  return (
    <div className="px-4 md:px-10 py-10 bg-gradient-to-r from-indigo-50 via-purple-50 to-pink-50 min-h-screen">
      ...
      <div className="flex flex-wrap justify-center gap-4 mb-6">
        ...
        <button
          onClick={generatePDF}
          className="bg-gradient-to-r from-green-400 to-blue-500 text-white px-4 py-2 rounded-xl shadow-lg hover:from-blue-500 hover:to-green-400 transition transform hover:scale-105"
        >
          Download PDF
        </button>
      </div>
